...
public class NewCarPresenter extends BasePresenter<NewCarListView> {

    public NewCarPresenter(NewCarListView view) {
        attachView(view);
    }

    public void postFindNewcarList(final String url, final HashMap map) {
                ...
                new ApiCallback<ResponseBody>() {
                    ...
                    public void onSuccess(ResponseBody responseBody) {
                        try {
                            ...
                            mvpView.onFindNewCarListSuccess();
                        } catch (IOException e) {
                            e.printStackTrace();
