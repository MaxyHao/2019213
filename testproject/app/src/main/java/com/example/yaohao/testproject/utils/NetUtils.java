...
public class NetUtils
{
	...
	public static boolean isConnected() {
		...
		ToastUtils.showShort(MyApplication.getInstance(), MyApplication.getInstance().getString(R.string.none_net));
		return false;
	}
...
//		ToastUtils.showShort(MyApp.getInstance(),MyApp.getInstance().getString(R.string.none_net));
		return false;
	}
